...
<body class="bodyss">
<div class="form">
	 <form class="login-form" action="editnow.php" method="POST">
	 		<h1 style="color:gray;">Edit guard info</h1>
      ...
      <input type="text" name="place" placeholder="Working place" value="<?php echo $data['place']?>" />
      <input type="text" name="hdate" placeholder="hire date" value="<?php echo $data['hdate']?>" />
      <input type="text" name="edate" placeholder="expire date" value="<?php echo $data['edate']?>" >
      <input type="text" name="available" value="<?php echo $data['available']?>" />
